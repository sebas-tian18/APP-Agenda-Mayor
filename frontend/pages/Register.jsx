    ...
    >
      <div className="min-h-screen bg-black bg-opacity-50 flex items-center ">
        ...
        <div className="basis-1/3 bg-white shadow-lg  flex min-w-[900px] ">
          <div className="bg-gradient-to-b from-emerald-500 to-indigo-500 basis-1/3 mr-3"></div>
            ...
            <form className="p-2">
              <div className="mb-4  ">
                ...
                <input
                  type="text"
                  name="nombres"
                  className="min-w-full my-1 border-b-2 border-[#FF5100] outline-0"
                  placeholder="Nombre1 Nombre2 Nombre3"
                ></input>
              </div>
              <div className="mb-4 grid grid-cols-2 flex-col ">
                <div>
                  ...
                  <input
                    type="text"
                    name="ApellidoP"
                    className=" my-1 border-b-2 border-[#FF5100] outline-0"
                ...
                <div>
                  ...
                  <input
                    type="text"
                    name="ApellidoP"
                    className="w-full my-1 border-b-2 border-[#FF5100] outline-0"
              ...
              <div className="mb-4 grid grid-cols-2 flex-col">
                <div>
                  ...
                  <input
                    type="text"
                    name="rut"
                    className="min-w-FIT my-1 border-b-2 border-[#FF5100] outline-0"
